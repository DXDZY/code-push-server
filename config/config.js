...
config.development = {
  ...
  db: {
    ...
    password: process.env.RDS_PASSWORD || 'xizhu211',
  ...
  local: {
    ...
    storageDir: process.env.STORAGE_DIR || "/Users/uxin/Documents/YXPProject/GitHub/myself/热更新服务器/storage",
    // storageDir: process.env.STORAGE_DIR || "/Users/tablee/workspaces/storage",
    // Binary files download host address which Code Push Server listen to. the files storage in storageDir.
    downloadUrl: process.env.LOCAL_DOWNLOAD_URL || "http://192.168.85.161:3000/download",//文件下载地址，对应app.js里的地址。
  ...
  common: {
    ...
    dataDir: process.env.DATA_DIR || "/Users/uxin/Documents/YXPProject/GitHub/myself/热更新服务器/data",
